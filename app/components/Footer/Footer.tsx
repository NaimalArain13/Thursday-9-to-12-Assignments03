    ...
    <footer className="bg-[#203e80] rounded-2xl mx-auto w-full max-w-7xl p-8 text-white">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="max-w-md w-full text-center md:text-left">
            <h1 className="text-2xl font-bold mb-2">Funders</h1>
        ...
        <div className="md:grid hidden gap-y-4 text-center md:grid-cols-3 md:gap-4">
          <div>
            <h4 className="text-lg font-semibold hover:text-orange-400">
              Donate
            </h4>
      ...
      <div className="grid grid-cols md:grid-cols-2 gap-8">
        ...
        <div className="hidden md:flex  md:space-x-4 md:items-center md:pt-5">
          <button className="bg-orange-400 hover:bg-orange-500 px-11 py-2  rounded-full flex items-center ">
